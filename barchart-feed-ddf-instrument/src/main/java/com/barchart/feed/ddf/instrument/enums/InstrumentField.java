...
import static com.barchart.feed.inst.api.InstrumentConst.NULL_CURRENCY;
...
public class InstrumentField<V extends Value<V>> extends
	...
	public static final InstrumentField<Fraction> FRACTION = NEW(Fraction.NULL_FRACTION);
